...
const Register = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (email && password && name) {
      const mockToken = "mock_jwt_token_register_" + role;
    ...
    <div className="flex-grow flex items-center justify-center relative overflow-hidden px-4 md:px-0 py-12 min-h-screen">
      ...
      <div className="w-full max-w-md z-10 bg-surface-container-lowest rounded-2xl shadow-xl shadow-primary/10 border border-outline-variant/50 p-8 md:p-10">
        <div className="mb-8 text-center">
          ...
          <h2 className="font-headline text-3xl font-extrabold text-on-surface mb-2">Register</h2>
          <p className="text-on-surface-variant text-sm">Create an account to join.</p>
        </div>
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          <div className="grid grid-cols-2 gap-3">
            <label className="cursor-pointer group">
              ...
              />
              <div className="flex items-center justify-center gap-2 p-3 rounded-xl border border-outline-variant peer-checked:border-primary peer-checked:bg-primary-fixed/20 transition-all duration-300">
                <span className="material-symbols-outlined text-sm peer-checked:text-primary">park</span>
                <span className="font-label text-xs font-bold uppercase tracking-tighter">Owner</span>
              </div>
            </label>
            <label className="cursor-pointer group">
              <input 
              ...
              />
              <div className="flex items-center justify-center gap-2 p-3 rounded-xl border border-outline-variant peer-checked:border-primary peer-checked:bg-primary-fixed/20 transition-all duration-300">
                <span className="material-symbols-outlined text-sm peer-checked:text-primary">shopping_bag</span>
                <span className="font-label text-xs font-bold uppercase tracking-tighter">Buyer</span>
              </div>
            </label>
          </div>
          ...
          <div className="space-y-4">
            <div>
              <label className="block font-label text-xs font-bold uppercase tracking-widest text-outline mb-1.5">Name</label>
              <input 
          ...
          <button className="w-full bg-primary text-on-primary py-3.5 rounded-lg font-headline font-bold hover:shadow-lg hover:shadow-primary/30 transition-all flex items-center justify-center gap-2 active:scale-[0.98] duration-200 mt-2" type="submit">
            <span>Register</span>
